...
%====================
\begin{figure}[!htbp]
	\subfigure[Surface mass density of particles. \label{fig:simulation_xy}]{\includegraphics[width=\columnwidth]{fig/plot_simulation_for_paper_2a.pdf}} %
    \subfigure[Mass density of particles. \label{fig:simulation_Rz}]{\includegraphics[width=\columnwidth]{fig/plot_simulation_for_paper_2b.pdf}}
...
\begin{figure}[!htbp]
\centering
 \subfigure[Surface density along $\phi$ at {$R_0= [5,8] ~ \text{kpc}$}. \label{fig:surf_dens_fourier_a}]{\includegraphics[width=0.7\columnwidth]{fig/plot_surface_density_phi_profile.pdf}}
  \subfigure[Spiral strength from Fourier mode analysis. \label{fig:surf_dens_fourier_b}]{\includegraphics[width=0.7\columnwidth]{fig/plot_Fourier_decomposition_of_disk_2.pdf}}
...
\centering
  ...
  \subfigure[Histogram of $\Delta_{\text{Spiral}}$.\label{fig:spiral_arm_DeltaS_b}]{\includegraphics[height=4cm]{fig/DeltaS_for_whole_galaxy_b.pdf}}
...
\begin{figure*}[!htbp]
\centering
	\subfigure[$r_\text{max}=2~\text{kpc}$. \label{fig:2kpcSuite}]{\includegraphics[width=0.6\textwidth]{fig/MNdHHdiffSph2_vcirc_surfdens_2kpcSuite.pdf}} % 
    \subfigure[$r_\text{max}=3~\text{kpc}$. \label{fig:3kpcSuite}]{\includegraphics[width=0.6\textwidth]{fig/MNdHHdiffSph2_vcirc_surfdens_3kpcSuite.pdf}}
