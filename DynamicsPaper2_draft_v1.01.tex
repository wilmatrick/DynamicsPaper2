...
\caption{\Wilma{[TO DO: Rewrite caption. Figure has changed.]} Contrast of the spiral arms in the fiducial survey volume of Section \Wilma{???}. As described in Section \Wilma{???} we quantify the strength of the spiral arm \Wilma{???} using Equation \Wilma{???} \Wilma{[TO DO: redo the plot, not all axes labels are shown.]}}
\label{fig:???}
\end{figure*}
%====================
