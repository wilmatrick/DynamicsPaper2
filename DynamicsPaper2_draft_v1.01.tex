...
The MW is, however, not axisymmetric. The bulge contains a strong bar \citep{1980ApJ...236..779L,1991ApJ...379..631B,2000MNRAS.317L..45H,2013MNRAS.435.1874W} and the disk itself is threaded by spiral arms \citep{976A&A....49...57G,2009PASP..121..213C,2014ApJ...783..130R} \Wilma{[TO DO: More references]} and (ring-like) overdensities \citep{2002ApJ...569..245N,2008ApJ...673..864J,2015ApJ...801..105X}, which induce non-circular motions and asymmetries in stellar number counts and correspond consequently to a non-axisymmetric gravitational potential and stellar DF.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{fig/MNdHHdiffSph2_4kpc8Spiral_a_test1_forces_overview_6.pdf}
...
\Wilma{[TO DO: Mention in text that volumes not containing R=8 and are very small have more difficulties recovering vcirc(8)]}
...
\Wilma{[TO DO: Mention in text analysis 2kpc5Spiral with its large disk scale length: Is on top of an intersection of two wide spiral arms, rather flat distribution, see Fig A3]}

\Wilma{[TO DO: Mention that most analyses average over spiral arms (for Fz), see Fig. 6, but those with fhalo=0 have a large bdisk to average over height.]}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{fig/MNdHHdiffSph2_bias_in_forces_recovery_2.pdf}
...
%some info beyond the survey volume could be used as external/prior constraints
...
\caption{Same as Figure \ref{fig:500pcSuite}, but for all survey volumes with $r_\text{max}=2~\text{kpc}$. Instead of marking the median of the radial stellar distribution, the dotted lines correspond here to the radial range within which the number of stars per radial bin $\Delta R = \Wilma{[TO DO]}$ is higher than average. This appears to be also the range within which the constraints are best. \Wilma{[TO DO: Make sure all final analyses are in this plot.]}}
\label{fig:2kpcSuite}
\end{figure*}
%====================
