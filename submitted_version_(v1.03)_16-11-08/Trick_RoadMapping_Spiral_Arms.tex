...
\begin{figure}[!htbp]
    ...
    {\includegraphics[width=\columnwidth]{plot_simulation_for_paper_2a.pdf}} %
    \subfigure[Mass density of particles. \label{fig:simulation_Rz}]
    {\includegraphics[width=\columnwidth]{plot_simulation_for_paper_2b.pdf}}
...
\centering
  ...
  \subfigure[Histogram of $\Delta_{\text{Spiral},k}$.\label{fig:spiral_arm_DeltaS_b}]{\includegraphics[height=4cm]{DeltaS_for_whole_galaxy_b.pdf}}
...
\begin{figure*}[!htbp]
\centering
  \subfigure[Equidensity contours, $\rho_\Phi(R,z)$. \label{fig:4kpc8Spiral_density_a}]{\includegraphics[height=4cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_density_overview_2a.pdf}}
    \subfigure[Density residuals. \label{fig:4kpc8Spiral_density_b}]{\includegraphics[height=4cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_density_overview_2b.pdf}}
      \subfigure[Radial local density profile. \label{fig:4kpc8Spiral_density_c}]{\includegraphics[height=4cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_density_overview_2c.pdf}}
        \subfigure[Vertical local density profile. \label{fig:4kpc8Spiral_density_d}]{\includegraphics[height=4cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_density_overview_2d.pdf}}
...
\begin{figure*}[!htbp]
\centering
  \subfigure[Circular velocity  curve. \label{fig:4kpc8Spiral_vcirc_surfdens_a}]{\includegraphics[height=4.5cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_vcirc_surfdens_overview_2a.pdf}}
    \subfigure[Surface density profile. \label{fig:4kpc8Spiral_vcirc_surfdens_b}]{\includegraphics[height=4.5cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_vcirc_surfdens_overview_2b.pdf}}
      \subfigure[Disk-to-halo surface density ratio. \label{fig:4kpc8Spiral_vcirc_surfdens_c}]{\includegraphics[height=4.5cm]{MNdHHdiffSph2_4kpc8Spiral_a_test1_vcirc_surfdens_overview_2c.pdf}}
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.6\textwidth]{MNdHHdiffSph2_4kpc8Spiral_a_data_bestfit_residuals_only_actions.pdf}
...
\centering
    ...
    {\includegraphics[width=0.6\textwidth]{MNdHHdiffSph2_vcirc_surfdens_2kpcSuite.pdf}} % 
    \subfigure[$r_\text{max}=3~\text{kpc}$. \label{fig:3kpcSuite}]
    {\includegraphics[width=0.6\textwidth]{MNdHHdiffSph2_vcirc_surfdens_3kpcSuite.pdf}}
...
\begin{figure*}[!htbp]
\centering
  \subfigure[Force accuracy at the stars' positions (with distance from ``Sun'' $r < r_\text{max}$). \label{fig:forces_bias_a}]{\includegraphics[height=9cm]{MNdHHdiffSph2_bias_in_forces_recovery_3_a.pdf}}
  \hspace{0.5cm}
    \subfigure[Force accuracy at regular grid points (with distance from ``Sun'' $r < 5~\text{kpc}$, height above plane $|z| \leq 1.5~\text{kpc}$). \label{fig:forces_bias_b}]{\includegraphics[height=9cm]{MNdHHdiffSph2_bias_in_forces_recovery_3_b.pdf}}
...
\begin{figure}[!htbp]
\centering
  \subfigure[Vertical force prediction vs.\ height above the plane. \label{fig:Fg_vs_z}]{\includegraphics[height=6.2cm]{MNdHHdiffSph2_Fg_vs_z_2.pdf}} %
    \subfigure[Vertical force prediction vs.\ galactocentric radius. \label{fig:Fg_vs_R}]{\includegraphics[height=6.2cm]{MNdHHdiffSph2_Fg_vs_R.pdf}}
...
\begin{figure*}[!htbp]
\centering
  \subfigure[Data sets centered on spiral arms (\texttt{S8} \& \texttt{S5}). \label{fig:mean_DeltaS_vs_frac10_grid_a}]{\includegraphics[height=6.2cm]{MNdHHdiffSph2_plot_meankappa_vs_frac10grid_5_spiral.pdf}}
  \hspace{0.5cm}
    \subfigure[Data sets centered on inter-arm regions (\texttt{I8} \& \texttt{I5}). \label{fig:mean_DeltaS_vs_frac10_grid_b}]{\includegraphics[height=6.2cm]{MNdHHdiffSph2_plot_meankappa_vs_frac10grid_5_void.pdf}}
