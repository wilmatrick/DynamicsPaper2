...
\centering
    ...
    \subfigure[$r_\text{max}=3~\text{kpc}$. \label{fig:???}]
...
\begin{figure*}[!htbp]
\centering
	\subfigure[$r_\text{max}=500~\text{pc}$. \label{fig:???}]{\includegraphics[width=0.6\textwidth]{fig/MNdHHdiffSph2_vcirc_surfdens_500pcSuite.pdf}} %
...
\begin{figure*}[!htbp]
\centering
	\subfigure[$r_\text{max}=4~\text{kpc}$. \label{fig:???}]{\includegraphics[width=0.6\textwidth]{fig/MNdHHdiffSph2_vcirc_surfdens_4kpcSuite.pdf}} %
	\subfigure[$r_\text{max}=5~\text{kpc}$. \label{fig:???}]{\includegraphics[width=0.6\textwidth]{fig/MNdHHdiffSph2_vcirc_surfdens_5kpcSuite.pdf}} 
